...
public class Triangle 
{
    ...
    public void Triangle(int providedSide1, int providedSide2, int providedSide3)
    {
        side1 = providedSide1;
        side2 = providedSide2;
        side3 = providedSide3;
    ...
    // get is right triangle? (done needs for testing)
    ...
    // get angles? (my option) easy logic with right triangle
    
    /* get angle from sides? (my option) 
    ...
    */
    ...
    private boolean isRight() 
    {
      ...
      * then I made it a facilitator which would mean it should be private
      * I did that after seeing project 2. Wanted to get this object complete 
